...
# Dynamic Crud with PHP, OOP, PDO
> **Note:** This repository contains the core code of a Dynamic Crud with PHP, OOP, PDO.
...
## About The Project
In computer programming, create, read, update, and delete are the four basic functions of persistent storage. Alternate words are sometimes used when defining the four basic functions of CRUD, such as retrieve instead of read, modify instead of update, or destroy instead of delete. In this project, I have practiced how to make a dynamic crud using PHP, OOP, PDO. 
...
1. Clone the repo
```sh
git remote add origin https://github.com/Masud99Rana/Dynamic-Crud-with-PHP-OOP-PDO.git
```
